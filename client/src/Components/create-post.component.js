...
const CreatePost = () => {
    ...
    return (
      <div style={{width:"100%",height:"100%"}}>
        <div className="container  container-sm px-4 w-50">
          <h1 style={{color:"black",fontFamily:"Arial",marginLeft:"20px"}}>Enter Post Details</h1>

            <form className="margin box box-shadow  text-dark" onSubmit={Submit}>
                <h4 className="form-error">{error}</h4>
                <hr/>
                <div className="form-group">
                    <p className="form-label" style={{marginLeft:"20px"}}>Image:</p>
                ...
                <hr/>
                <div className="form-group">
                    <p className="form-label" style={{marginLeft:"20px"}}>Add Some Thing About This Event:</p>
                    <textarea rows="8" className="form-control" maxLength="5000" value={description} onChange={({ target: { value } }) => setDescription(value)} required></textarea>
                </div>
                <hr/>
                <div className="form-group">
                    <p className="form-label" style={{marginLeft:"20px"}}>Tags:</p>
                    <textarea rows="5" className="form-control" placeholder="@username" value={tags} onChange={ChangeTags}></textarea>
                </div>
                <hr/>
                <div className="form-group">
                    <p className="form-label" style={{marginLeft:"20px"}}>Hastags:</p>
                    <textarea rows="5" className="form-control" placeholder="#tagname" value={hashtags} onChange={ChangeHastags}></textarea>
                </div>
                <div className="form-group">
