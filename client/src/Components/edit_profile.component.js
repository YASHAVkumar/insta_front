...
const EditProfile = () => {
    ...
    return (
        <form className="container w-50 margin box box-shadow" onSubmit={Submit}>
            ...
            <div className="form-group">
                <h4 className="form-label"><NavLink to="/setting/profile-picture" className="link">Update Profile</NavLink></h4>
            </div>
            <br/>
            <div className="form-group">
                <input type="Submit" className="form-control btn btn-lg btn-outline-primary btn-dark" style={{width:"80%"}} />
            </div>
            <br /><br /><br />
